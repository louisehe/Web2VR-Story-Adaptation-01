 ...
 *   URL: https://www.nytimes.com/interactive/2018/06/19/world/americas/guatemala-volcano-augmented-reality-ar-ul.html
 *
 ...
 *  3. 先把控制台打印的【DISCOVERY REPORT】那几行发给 Claude,再把下载的 nyt_volcano__* 丢进 09glb。
 *
 * 仅收集页面公开加载的资产,不绕过付费墙/鉴权/DRM。
 */
(async () => {
  const PREFIX = 'nyt_volcano__';
  ...
  log('DONE. 先把上面的 DISCOVERY REPORT 发给 Claude;下载的 nyt_volcano__* 放进 09glb。');
})();
