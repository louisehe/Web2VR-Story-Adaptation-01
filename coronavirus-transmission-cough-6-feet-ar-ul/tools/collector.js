 ...
 *   URL: https://www.nytimes.com/interactive/2020/04/14/science/coronavirus-transmission-cough-6-feet-ar-ul.html
 *
 ...
 *  3. 先把控制台打印的【DISCOVERY REPORT】那几行发给 Claude,再把下载的 nyt_distance__* 丢进 06glb。
 *
 * 仅收集页面公开加载的资产,不绕过付费墙/鉴权/DRM。
 */
(async () => {
  const PREFIX = 'nyt_distance__';
  ...
  log('DONE. 先把上面的 DISCOVERY REPORT 发给 Claude;下载的 nyt_distance__* 放进 06glb。');
})();
